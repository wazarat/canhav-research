          ...
          <div className="container mx-auto px-6 py-20 max-w-6xl">
            ...
            <section className="mb-24">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                {/* Image Placeholder for Research Impact */}
                <div className="lg:order-last">
                  <div className="bg-gradient-to-br from-purple-100 to-indigo-100 rounded-2xl p-8 h-80 flex items-center justify-center shadow-lg">
                    <div className="text-center">
                      ...
                      <p className="text-purple-700 font-medium">Research Impact Image</p>
                      <p className="text-sm text-purple-600">Queen's Innovation Centre</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section className="mb-24">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                {/* Image Placeholder for Recognition */}
                <div>
                  <div className="bg-gradient-to-br from-orange-100 to-red-100 rounded-2xl p-8 h-80 flex items-center justify-center shadow-lg">
                    <div className="text-center">
                      ...
                      <p className="text-orange-700 font-medium">Recognition Image</p>
                      <p className="text-sm text-orange-600">Coin Pitchfest Achievement</p>
                    </div>
                  </div>
                </div>
